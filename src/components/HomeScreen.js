         ...
         >
           <div className="absolute p-8 flex flex-col space-y-8">
                ...
                <div className="ml-8 w-96">Need a car? Oh, you've come to the right place. Book cars on demand 
                    by the hour or day. Join instantly , drive in minutes. </div>
                <div className="flex flex-row space-x-2">
                    <div className="w-32 rounded text-white bg-black p-2 text-center" onClick={()=>setShowBookingForm(true)}>Booking now</div>
                    <div className="w-32 rounded text-white bg-black p-2 text-center" onClick={()=>setShowCheckoutModal(true)}>See all cars</div>
                </div>
           </div>
